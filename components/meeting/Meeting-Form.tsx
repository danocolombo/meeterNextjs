...
const MeetingForm = ({ id, showToast }: MeetingFormProps) => {
    ...
    const handleUpdate = async (formData: MeetingFormData) => {
        // Add immediate console.log at the start of the function
        console.log('🔥 handleUpdate called with formData:', formData);
        debugger; // Add debugger statement to help with debugging
    ...
    return (
        <div className='space-y-8'>
            <div className='form-container'>
                <form
                    onSubmit={(e) => {
                        console.log('🔥 MF:417-->Form submitted');
